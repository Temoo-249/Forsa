...
export const FeedView: React.FC<FeedViewProps> = ({
  ...
  const [skillsList, setSkillsList] = useState<string[]>(['React', 'Web Development']);
  ...
  const handleCreatePost = (e: React.FormEvent) => {
    ...
    onAddPost({
      authorName: 'أحمد الرشيد',
      authorHeadline: 'Senior Full Stack Developer | React & Node.js',
      authorAvatar: 'أر',
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      ...
      <div className="lg:col-span-8 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xs p-4 sm:p-5 flex items-center justify-between gap-4">
          ...
          <button
            ...
            title="الرجوع إلى شاشة الترحيب ومقدمة المنصة"
          >
      ...
      <div className="lg:col-span-4 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xs p-5 text-center space-y-4">
          ...
          <div>
            <h3 className="font-bold text-base text-slate-900">أحمد الرشيد</h3>
            <p className="text-xs text-slate-500 font-medium">Senior Full Stack Developer</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 py-3 border-y border-slate-100 text-center">
            ...
            <div className="border-x border-slate-100">
              <span className="text-base font-black text-slate-900 block">847</span>
              <span className="text-[11px] text-slate-400 font-medium">مشاهدات</span>
            </div>
            <div>
              <span className="text-base font-black text-slate-900 block">2.4k</span>
