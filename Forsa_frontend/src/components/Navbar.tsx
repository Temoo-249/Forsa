          ...
          <div className="flex items-center gap-6 lg:gap-8">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 py-2 rounded-lg text-xs font-semibold transition-all duration-150 cursor-pointer ${
                  currentTab === 'landing'
                    ? 'bg-blue-50 text-blue-700 font-bold shadow-xs ring-1 ring-blue-200'
                    : 'text-slate-500 hover:text-slate-800 hover:bg-slate-100/70'
                }`}
                title="شاشة البداية ومقدمة المنصة"
              >
                <Sparkles className="w-3.5 h-3.5 text-blue-600" />
                <span className="hidden xl:inline">مقدمة المنصة</span>
              </button>
                  ...
                  >
                    ...
                    <div className="p-2 space-y-1">
                      ...
                      >
                        ...
                        <span>شاشة البداية والتعريف</span>
                      </button>
